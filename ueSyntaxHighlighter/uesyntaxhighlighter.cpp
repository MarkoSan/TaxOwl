...
UeSyntaxHighlighter::UeSyntaxHighlighter(QTextDocument* const parent)
...
UeSyntaxHighlighter::~UeSyntaxHighlighter()
{
}

void UeSyntaxHighlighter::highlightBlock(const QString& text)
{
